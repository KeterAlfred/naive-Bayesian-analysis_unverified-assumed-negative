...
#Number of datasets
M=25
j=0  # will consider datasets c(1 : M)+j in sim_dat created in the data_for_sim_model1_MNAR_4_groups.R code
...
#Source the dataset
source("data_for_sim1_NN_naive1.R")
...
time.1 <- system.time( #getDoParWorkers( )
  vb.NN.sim1.naive.res1_25 <- foreach( m = 1:M, .inorder = FALSE, 
...
saveRDS(vb.NN.sim1.naive.res1_25, file = "/kyukon/data/gent/438/vsc43892/vb_sim_analysis/vb.NN.sim1.naive.res1_25.RData")


# print(vb.NN.sim1.naive.res1_25[1], intervals = c(0.5, 0.025, 0.975))
